...
# autoreconf --force
%configure --disable-static --with-gnutls --disable-spdy
make %{?_smp_mflags}
...
%changelog
* Mon Jul 07 2014 Lukáš Nykrýn <lnykryn@redhat.com> - 0.9.33-4
- remove demo

* Mon Jul 07 2014 Lukáš Nykrýn <lnykryn@redhat.com> - 0.9.33-3
- disable spdy
